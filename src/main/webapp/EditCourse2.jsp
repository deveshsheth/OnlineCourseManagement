		...
		<div class="content">
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2">
					<form action="UpdateCyberSecurityAdmin" method="post">
						<input type="hidden" name="csid" value="${bean.csid}" />
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<label><b>Code</b></label> <input class="form-control"
										type="text" name="ccode" value="${bean.ccode}">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label><b>Course Name</b></label> <input class="form-control"
										type="text" name="cname" value="${bean.cname}">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label><b>Duration</b></label> <input class="form-control"
										type="text" name="cduration" value="${bean.cduration}">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label><b>Price</b></label> <input class="form-control"
										type="text" name="cprice" value="${bean.cprice}">
								</div>
							</div>
