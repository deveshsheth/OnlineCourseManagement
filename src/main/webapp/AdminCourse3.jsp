		...
		<div class="content">
			...
			<div class="row">
				...
				<div class="col-sm-8 col-9 text-right m-b-20">
					<a href="AddCourse3.jsp"><button type="button"
							class="btn btn-outline-info waves-effect">+ Add</button></a>
				</div>
			</div>

			<table id="tblCustomers" class="table">
				<caption>List of WebDevelopment Course</caption>
				<thead>
					<tr>
						<!-- <th scope="col">#</th> -->
				...
				<tbody>
					...
					%>
					<tr>
						<%-- <th scope="row"><%=wd.getWdid()%></th> --%>
						<td><%=wd.getWcode()%></td>
						<td><%=wd.getWname()%></td>
						<td><%=wd.getWduration()%></td>
						<td><%=wd.getWprice()%></td>
						<td><a href="EditWebDevelopmentAdmin?wdid=<%=wd.getWdid()%>">Edit</a>
							| <a href="DeleteWebDevelopmentAdmin?wdid=<%=wd.getWdid()%>">Delete</a>
						</td>
					</tr>
					<%
					}
