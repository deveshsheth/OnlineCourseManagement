...
<%@page import="com.dao.AddDataScienceDao"%>
<%@page import="java.util.List"%>
<%@page import="com.bean.DataScienceBean"%>
...
<body>
	...
	<%
	ArrayList<DataScienceBean> datascience = (ArrayList<DataScienceBean>) request.getAttribute("rs");
	%>
			...
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li><a href="ListUsers"><i class="fas fa-user"></i> <span>Users</span></a></li>
	...
	<div class="page-wrapper">
		...
		<div class="content">
			...
			<table id="tblCustomers" class="table">
				...
				<tbody>
					<%
					for (DataScienceBean ds : datascience) {
					%>
					<tr>
						<%-- <th scope="row"><%=ds.getDsid()%></th> --%>
						<td><%=ds.getDcode()%></td>
						<td><%=ds.getDname()%></td>
						<td><%=ds.getDduration()%></td>
						<td><%=ds.getDprice()%></td>
						<td><a href="EditDataScienceAdmin?dsid=<%=ds.getDsid()%>">Edit</a>
							| <a href="DeleteDataScienceAdmin?dsid=<%=ds.getDsid()%>">Delete</a>
						</td>
					</tr>
					<%
					}
