...
<body>
	...
	String dnameError = (String) request.getAttribute("dnameError");
	String ddurationError = (String) request.getAttribute("ddurationError");
	String dpriceError = (String) request.getAttribute("dpriceError");

	String dcodeValue = (String) request.getAttribute("dcodeValue");
	String dnameValue = (String) request.getAttribute("dnameValue");
	String ddurationValue = (String) request.getAttribute("ddurationValue");
	String dpriceValue = (String) request.getAttribute("dpriceValue");
	%>
			...
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li class="active"><a href="ListDataScienceAdmin"><i
								class="fas fa-laptop"></i> <span>Data Science</span></a></li>
						<li><a href="ListCyberSecurityAdmin"><i class="fas fa-laptop"></i>
								<span>CyberSecurity</span></a></li>
		...
		<div class="content">
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2">
					<form action="AddDataScience" method="POST">
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<label><b>Code</b></label> <input class="form-control"
										type="text" name="dcode"
										value="<%=dcodeValue == null ? "" : dcodeValue%>">
									<p style="color: red"><%=dcodeError == null ? "" : dcodeError%></p>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label><b>Course Name</b></label> <input class="form-control"
										...
										value="<%=dnameValue == null ? "" : dnameValue%>">
									<p style="color: red"><%=dnameError == null ? "" : dnameError%></p>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label><b>Duration</b></label> <input class="form-control"
										type="text" name="dduration"
										value="<%=ddurationValue == null ? "" : ddurationValue%>">
									<p style="color: red"><%=ddurationError == null ? "" : ddurationError%></p>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label><b>Price</b></label> <input class="form-control"
										type="text" name="dprice"
										value="<%=dpriceValue == null ? "" : dpriceValue%>">
									<p style="color: red"><%=dpriceError == null ? "" : dpriceError%></p>
								</div>
							</div>
