				...
				<div id="table" class="table-editable">
					...
					<table
						...
						<tbody>
							...
							%>
							<tr>
								<td class="pt-3-half" contenteditable="true"><%=ds.getDname()%></td>
								<td class="pt-3-half" contenteditable="true"><%=ds.getDduration()%></td>
								<td class="pt-3-half" contenteditable="true"><%=ds.getDprice()%></td>
								<td><a href="addcartdatascience"><span class="table-remove"><button type="button"
