				...
				<div id="table" class="table-editable">
					...
					<table
						...
						<tbody>
							...
							%>
							<tr>
								<td class="pt-3-half" contenteditable="true"><%=cs.getCname()%></td>
								<td class="pt-3-half" contenteditable="true"><%=cs.getCduration()%></td>
								<td class="pt-3-half" contenteditable="true"><%=cs.getCprice()%></td>
								<td><a href="AddtoCartCyberSecurity"><span class="table-remove"><button type="button"
