		...
		<div class="content">
			...
			<div class="row">
				<div class="col-sm-4 col-3">
					<h4 class="page-title">
						<b>Edit DataScience Course</b>
					</h4>
				</div>
				<!--   <div class="col-sm-8 col-9 text-right m-b-20">
                       <button type="button" class="btn btn-outline-info waves-effect">+ Add</button>
                    </div> -->
			</div>
			<br> <br>
			<div class="row">
				<div class="col-lg-8 offset-lg-2">
					<form action="UpdateDataScience" method="post">
						<input type="hidden" name="dsid" value="${bean.dsid}" />
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<label><b>Code</b></label> <input class="form-control"
										type="text" name="dcode" value="${bean.dcode}">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label><b>Course Name</b></label> <input class="form-control"
										type="text" name="dname" value="${bean.dname}">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label><b>Duration</b></label> <input class="form-control"
										type="text" name="dduration" value="${bean.dduration}">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label><b>Price</b></label> <input class="form-control"
										type="text" name="dprice" value="${bean.dprice}">
								</div>
							</div>
