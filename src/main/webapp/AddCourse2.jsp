...
<body>
	...
	<%
	String ccodeError = (String) request.getAttribute("ccodeError");
	String cnameError = (String) request.getAttribute("cnameError");
	String cdurationError = (String) request.getAttribute("cdurationError");
	String cpriceError = (String) request.getAttribute("cpriceError");

	String ccodeValue = (String) request.getAttribute("ccodeValue");
	String cnameValue = (String) request.getAttribute("cnameValue");
	String cdurationValue = (String) request.getAttribute("cdurationValue");
	String cpriceValue = (String) request.getAttribute("cpriceValue");
	%>
		...
		<div class="content">
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2">
					<form action="AddCyberSecurity" method="post">
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<label><b>Code</b></label> <input class="form-control"
										type="text" name="ccode"
										value="<%=ccodeValue == null ? "" : ccodeValue%>">
									<p style="color: red"><%=ccodeError == null ? "" : ccodeError%></p>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label><b>Course Name</b></label> <input class="form-control"
										...
										value="<%=cnameValue == null ? "" : cnameValue%>">
									<p style="color: red"><%=cnameError == null ? "" : cnameError%></p>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label><b>Duration</b></label> <input class="form-control"
										type="text" name="cduration"
										value="<%=cdurationValue == null ? "" : cdurationValue%>">
									<p style="color: red"><%=cdurationError == null ? "" : cdurationError%></p>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label><b>Price</b></label> <input class="form-control"
										type="text" name="cprice"
										value="<%=cpriceValue == null ? "" : cpriceValue%>">
									<p style="color: red"><%=cpriceError == null ? "" : cpriceError%></p>
								</div>
							</div>
